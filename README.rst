...
SDK 依赖的 JSON API 已弃用，请直接使用基于 XML API 的 `cos-python-sdk-v5 <https://github.com/tencentyun/cos-python-sdk-v5>`_，或者参照 `升级指引 <https://cloud.tencent.com/document/product/436/31356>`_ 升级到新版SDK。
